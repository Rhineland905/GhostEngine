...
using GhostEngine.Core;
using GhostEngine.Core.Effects;
using GhostEngine.Core.Inputs;
...
namespace GhostEngine.Screens
{
    ...
    internal class MainMenuScreen : MenuScreen
    {
        ...
        private void SetLanguageText()
        {
            ...
            Title = "GhostEngine"; // TODO uncomment this if you want it to use Resources.MainMenu; instead
        }
        ...
        public override void LoadContent()
        {
            ...
            settingsManager ??= ScreenManager.Game.Services.GetService<SettingsManager<GhostEngineSettings>>();
