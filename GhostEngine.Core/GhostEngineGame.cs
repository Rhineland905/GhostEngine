...
using GhostEngine.Core.Effects;
using GhostEngine.Core.Localization;
using GhostEngine.Core.Settings;
using GhostEngine.ScreenManagers;
using GhostEngine.Screens;
using Microsoft.Xna.Framework;
using Microsoft.Xna.Framework.Graphics;

namespace GhostEngine.Core
{
    /// <summary>
    ...
    /// </remarks>}
    public class GhostEngineGame : Game
    {
        ...
        private SettingsManager<GhostEngineSettings> settingsManager;

        // Manages leaderboard data for tracking high scores and achievements.
        private SettingsManager<GhostEngineLeaderboard> leaderboardManager;
        ...
        public GhostEngineGame()
        {
            ...
            settingsManager = new SettingsManager<GhostEngineSettings>(storage);
            Services.AddService(typeof(SettingsManager<GhostEngineSettings>), settingsManager);

            leaderboardManager = new SettingsManager<GhostEngineLeaderboard>(storage);
            Services.AddService(typeof(SettingsManager<GhostEngineLeaderboard>), leaderboardManager);
